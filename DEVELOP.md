...
1.  Happy hacking!
    ...
    ```Bash
    cd src/addons/volto-slots/
    ```

### Or add @eeacms/volto-slots to your Volto project
...
project where you added `volto-slots` to `mrs.developer.json`
...
This will build and start with Docker a clean `Plone backend` and `Volto Frontend` with `volto-slots` block installed.
